		...
		handler: function tapGesture(ev, inst) {
			if(ev.eventType == Hammer.EVENT_END) {
				...
				if(ev.deltaTime > inst.options.tap_max_touchtime ||
					ev.target != ev.startEvent.target //Tap works more like a mouse click, fires aslong as they're touching the same element, no matter if they move. REMOVE IF ISSUES^^^
